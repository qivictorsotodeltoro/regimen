...
En el gráfico se observa: - La línea horizontal en cero, que representa el régimen esperado. - Las desviaciones positivas y negativas respecto a ese régimen. - Posibles zonas donde los residuales dejan de oscilar simétricamente.
...
Desde una perspectiva de gestión y rendición de cuentas, el CUSUM cumple un rol clave:
...
-   **Tipo de cambio**: cambio en la **media** (*Change in mean*).
-   **Variable analizada**: residuales del modelo de referencia.
...
-   [El **cambio de régimen se detecta en la semana 10**.]{.underline}
-   A partir de ese punto, el proceso exhibe un comportamiento estadísticamente distinto al observado antes.
...
-   Es **no narrativo**: la fecha no se “elige”, se estima.
...
En este enfoque, el CUSUM cumple un rol específico:
...
Con esta integración visual se cierra el workflow completo:
...
-   La conclusión puede ser defendida técnica, regulatoria y científicamente.
